// https://github.com/nodejs/node/blob/adaf60240559ffb58636130950262ee3237b7a41/lib/internal/test_runner/test.js
...
// https://github.com/nodejs/node/blob/b476b1b91ef8715f096f815db5a0c8722b613678/lib/internal/validators.js
...
class TestContext {
  ...
  diagnostic (message) {
    this._test.diagnostic(message)
  }

  skip (message) {
    this._test.skip(message)
  }

  todo (message) {
    this._test.todo(message)
  }

  test (name, options, fn) {
    const subtest = this._test.createSubtest(name, options, fn)
